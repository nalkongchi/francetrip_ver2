...
window.TRIP_DAYS = {
  ...
  2: {
    ...
    connectHotels: true,
    segments: [[
      { name: 'Carette (보쥬 광장 점)', lat: 48.8551, lng: 2.3625, icon: '🥐', maps_url: 'https://maps.app.goo.gl/6pMKuJy1v6mad6W67' },
      ...
      { name: 'Mariage Frères Marais', lat: 48.8572, lng: 2.3536, icon: '🍵', maps_url: 'https://maps.app.goo.gl/n5vXL5dWWYv3UBPW6' },
      ...
      { name: 'Breizh Café Montorgueil', lat: 48.8631, lng: 2.3468, icon: '🥞', maps_url: 'https://maps.app.goo.gl/KQFsWWwbjBQokuza9' }
    ]]
  },
  ...
  3: {
    ...
    segments: [[
      ...
      { name: 'Bistrot Victoires', lat: 48.8625, lng: 2.3425, icon: '🦆', maps_url: 'https://maps.app.goo.gl/L9WwCf1UFYEryfu57' },
      ...
      { name: 'Bouillon République', lat: 48.8671, lng: 2.3631, icon: '🐌', maps_url: 'https://maps.app.goo.gl/RsEZ4NyA5QZxSmsU7' }
    ]]
  },
  ...
  4: {
    ...
    connectHotels: true,
    segments: [[
      { name: 'Le Pain des Copains', lat: 48.8684, lng: 2.3594, icon: '🥐', maps_url: 'https://maps.app.goo.gl/B2TddHQuT2KbUm8x6' },
      { name: '생마르탱 운하', lat: 48.8698, lng: 2.3637, icon: '🛶', maps_url: 'https://maps.app.goo.gl/ybpjb3FXmnCsdPAF6' },
      { name: '유토피아 베이커리', lat: 48.8625, lng: 2.3520, icon: '🥖', maps_url: 'https://maps.app.goo.gl/HdKJ3EthYLNV2Diq9' },
      { name: 'Square Jules Ferry', lat: 48.8679, lng: 2.3648, icon: '🌳', maps_url: 'https://maps.app.goo.gl/RV35nEu1vh5xW7d16' },
      { name: 'La Poste (160 Rue du Temple)', lat: 48.8618, lng: 2.3548, icon: '💌', maps_url: 'https://maps.app.goo.gl/sur3ob9K4of7aPvWA' },
      ...
      { name: 'Sunflower Café', lat: 48.8550, lng: 2.2978, icon: '☕', maps_url: 'https://maps.app.goo.gl/qGLvH9xShzdxbSaM7' },
      { name: '비라켐 다리', lat: 48.8517, lng: 2.2880, icon: '🌉', maps_url: 'https://maps.app.goo.gl/4UEWxj3tbi8kn9Xi6' },
      { name: "L'Atypic", lat: 48.8527, lng: 2.2965, icon: '🥩', maps_url: 'https://maps.app.goo.gl/uaBj9PL2qWF4r8cB9' },
      { name: '바토 파리지앵 선착장', lat: 48.8601, lng: 2.2958, icon: '🚢', maps_url: 'https://maps.app.goo.gl/yxCDpmpt28zLXfRR9' }
    ]]
  },
  ...
  5: {
    ...
    segments: [
      [
        { name: '파리 동역 (Gare de l’Est)', lat: 48.8767, lng: 2.3590, icon: '🚄', maps_url: 'https://maps.app.goo.gl/e6dJPXGKBzUbFnPT8' }
      ],
      [
        { name: '스트라스부르 역', lat: 48.5851, lng: 7.7341, icon: '🚄', maps_url: 'https://maps.app.goo.gl/bddfiAsgx5PQD3ba9' },
        { name: 'Winstub Le Zehnerglock', lat: 48.5804, lng: 7.7468, icon: '🍽', maps_url: 'https://maps.app.goo.gl/tsKG6i91WJsgqM1Q9' },
        ...
        { name: 'La Fignette', lat: 48.5798, lng: 7.7460, icon: '🔥', maps_url: 'https://maps.app.goo.gl/scasdyVUWjxo9mT39' }
      ]
    ]
  },
  ...
  6: {
    ...
    segments: [
      ...
      [
        ...
        { name: 'WISTUB BRENNER', lat: 48.0782, lng: 7.3568, icon: '🍷', maps_url: 'https://maps.app.goo.gl/7Qjy6YBsjJN3EdNF9' },
        { name: 'Pâtisserie Gilg', lat: 48.0791, lng: 7.3567, icon: '🍰', maps_url: 'https://maps.app.goo.gl/wEwyyJ1aLppDrB319' },
      ...
      [
        { name: '스트라스부르 역', lat: 48.5851, lng: 7.7341, icon: '🚂', maps_url: 'https://maps.app.goo.gl/bddfiAsgx5PQD3ba9' },
        { name: 'Maison Kammerzell', lat: 48.5819, lng: 7.7507, icon: '🐟', maps_url: 'https://maps.app.goo.gl/EfMdpUQtHNk9tMg2A' },
  ...
  7: {
    ...
    segments: [[
      ...
      { name: 'Café Backhaus Dreher', lat: 48.5793, lng: 7.8102, icon: '🥨', maps_url: 'https://maps.app.goo.gl/SssgYb2RASvds1uc6' },
      ...
      { name: 'Le Tire-Bouchon', lat: 48.5814, lng: 7.7492, icon: '🍷', maps_url: 'https://maps.app.goo.gl/aJnQMWgfH3gVnqAV6' }
    ]]
  },
  ...
  8: {
    ...
    segments: [
      [
        { name: '스트라스부르 역 (TGV 출발)', lat: 48.5851, lng: 7.7341, icon: '🚄', maps_url: 'https://maps.app.goo.gl/bddfiAsgx5PQD3ba9' }
      ],
      [
