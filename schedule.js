window.SCHEDULE_DATA = {
  ...
  1: {
    ...
    events: [
      ...
      { id: 'day1_05', lang_id: 'day1_05', type: 'hotel',    time: '19:30–20:00', title: '🏨 숙소(디스트릭트 레퓌블리크) 체크인', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], maps_url: 'https://maps.app.goo.gl/zn61XhanYKruqqum6' },
  ...
  2: {
    ...
    events: [
      ...
      { id: 'day2_04', lang_id: 'day2_04', type: 'sightseeing', time: '10:20–11:00', title: '🏠 빅토르 위고 하우스', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '외관 구경, 시간 되면 내부 관람(무료)', maps_url: 'https://maps.app.goo.gl/KRC8g3DnkpM3Q53u6' },
      ...
      { id: 'day2_07', lang_id: 'day2_07', type: 'food',        time: '12:00–13:00', title: "🥙 점심: L'As du Fallafel", tags: [{cls:'tag-openrun',text:'🚶오픈런'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: 'Falafel sandwich, Shawarma pita', maps_url: 'https://maps.app.goo.gl/iUi5xbPobLxwC7uZ9' },
      { id: 'day2_08', lang_id: 'day2_08', type: 'food',        time: '13:00–15:00', title: '🍵 카페/티타임: Mariage Frères Marais', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: "애프터눈 티 세트 'SWEET DREAM' : JOYFUL HORSE 선택, UME CHA 2026 단품 추가", maps_url: 'https://maps.app.goo.gl/n5vXL5dWWYv3UBPW6', foldNote: '마라톤 코스가 Rue de Rivoli(리볼리 거리) 및 시청사 인근을 통과하므로, 오후 2시 이전에는 남쪽(센강 방향)으로 무리하게 이동하지 말 것.' },
      ...
      { id: 'day2_11', lang_id: 'day2_11', type: 'sightseeing', time: '16:30–17:30', title: '⛪ 노트르담 대성당', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '정면 파사드 → 측면/후면으로 한 바퀴 → 내부 입장 및 관람 → 광장 포토스팟', maps_url: 'https://maps.app.goo.gl/LjFBhCaFeZRdprCC6' },
      ...
      { id: 'day2_17', lang_id: 'day2_17', type: 'food',        time: '20:00–21:30', title: '🥞 저녁: Breizh Café Montorgueil', tags: [{cls:'tag-confirm', text:'⏰ 20:00'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: 'La Complète 갈레트(햄, 치즈, 계란), 특선 갈레트(Galette de spécialité), Cidre Brut(시드르 브뤼)', maps_url: 'https://maps.app.goo.gl/KQFsWWwbjBQokuza9', foldNote: '메인: La Complète 갈레트(햄, 치즈, 계란) 1개 + 해산물이나 버섯이 들어간 특선 갈레트(Galette de spécialité) 1개<br>주류: 드라이한 사과주 Cidre Brut(시드르 브뤼)를 피셰(단지)로 주문해서 나눠 먹기<br>디저트: 식후에 달콤한 Caramel au beurre salé (수제 솔티드 카라멜 크레페) 하나를 추가(선택)' },
      { id: 'day2_18', lang_id: 'day2_18', type: 'transport',   time: '21:30–22:00', title: '🚇 식당 → 숙소 복귀', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], note: '✅ 지하철 3호선 Sentier → République (환승 없음) / 하차 후: Sortie 5 (Boulevard de Magenta) 출구' },
  ...
  3: {
    ...
    events: [
      { id: 'day3_01', lang_id: 'day3_01', type: 'transport',   time: '08:00–08:25', title: '🚇 오텔 드 빌(시청사) 이동', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], note: '✅ 탑승 루트: 숙소 앞 République(레퓌블리크) 역 진입 → 11호선(Châtelet 방향) 탑승 → Hôtel de Ville 역 하차' },
      ...
      { id: 'day3_08', lang_id: 'day3_08', type: 'food',        time: '11:30–13:00', title: '🦆 점심: Bistrot Victoires', tags: [{cls:'tag-openrun',text:'🚶오픈런'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: 'Confit de canard 오리 콩피', maps_url: 'https://maps.app.goo.gl/L9WwCf1UFYEryfu57' },
      { id: 'day3_09', type: 'transport',   time: '13:00–13:20', title: '🚶 라파예트 백화점 이동', detail: '도보' },
      { id: 'day3_10', lang_id: 'day3_10', type: 'sightseeing', time: '13:20–14:40', title: '🛍 갤러리 라파예트 백화점(오스만)', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '8층 옥상 테라스 에펠탑 뷰 감상 → 본관 1층 라뒤레 마카롱 → 고메관 0층 피에르 에르메 이스파한 테이크아웃', maps_url: 'https://maps.app.goo.gl/61PZdT6BYCrYWf8z6' },
      ...
      { id: 'day3_15', lang_id: 'day3_15', type: 'sightseeing', time: '17:30–18:30', title: '🛍 샹젤리제 거리 걷기', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '샹젤리제 거리 구경<br>시간 남으면 Le Café Lacoste Paris 카페 방문', maps_url: 'https://maps.app.goo.gl/rpM2Vq2SUywPsAMY8' },
  ...
  4: {
    ...
    events: [
      ...
      { id: 'day4_06', lang_id: 'day4_06', type: 'transport',   time: '12:00–13:00', title: '🚇 우체국 → 레퓌블리크 광장 → 에펠탑(트로카데로) 이동', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '레퓌블리크 광장에서 마리안(Marianne) 동상 인증샷', note: '✅ 탑승 루트: République 역 → 9호선(Pont de Sèvres 방향) → Trocadéro 하차 (환승 없이 약 20분)' },
      ...
      { id: 'day4_16', lang_id: 'day4_16', type: 'food',        time: '19:15–21:00', title: "🥩 저녁: L'Atypic", tags: [{cls:'tag-confirm',text:'⏰ 19:15'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: '푸아그라, 타르타르, 스테이크', maps_url: 'https://maps.app.goo.gl/uaBj9PL2qWF4r8cB9', foldNote: '전채(Entrée): 푸아그라(Foie gras)<br>푸아그라는 빵에 발라 먹으면 되며, 이때 셰프에게 추천받아 달콤한 화이트 와인(예: 소테른 Sauternes) 1잔을 곁들여 푸아그라의 풍미를 극대화<br>메인(Plat): 타르타르(프랑스식 육회) + 스테이크(Steak)' },
  ...
  5: {
    ...
    events: [
      ...
      { id: 'day5_02', lang_id: 'day5_02', type: 'transport', time: '09:30–12:00', title: '🚄 TGV → 스트라스부르 이동', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: "10:08 Paris Gare de l'Est 출발 → 11:54 Strasbourg 도착", maps_url: 'https://maps.app.goo.gl/e6dJPXGKBzUbFnPT8', note: '✅ 기차 OUIGO Grande Vitesse 7691 - 좌석: Voiture 8 / 803–804' },
      ...
      { id: 'day5_05', lang_id: 'day5_05', type: 'food',      time: '13:00–14:30', title: '🍽 점심: Winstub Le Zehnerglock', tags: [{cls:'tag-confirm',text:'⏰ 13:00'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: 'Choucroute Garnie(슈쿠르트), Baeckeoffe(베크오프), 알자스산 화이트 와인(Riesling 리슬링)', maps_url: 'https://maps.app.goo.gl/tsKG6i91WJsgqM1Q9' },
      ...
      { id: 'day5_09', lang_id: 'day5_09', type: 'food',      time: '18:30–20:00', title: '🔥 저녁: La Fignette', tags: [{cls:'tag-openrun',text:'🚶오픈런'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: '플람퀴슈(Tarte Flambée Traditionnelle, Gratinée)', maps_url: 'https://maps.app.goo.gl/scasdyVUWjxo9mT39' },
  ...
  6: {
    ...
    events: [
      { id: 'day6_01', lang_id: 'day6_01', type: 'transport',   time: '08:00–09:00', title: '🚂 스트라스부르 → 콜마르 (TER 기차)', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], maps_url: 'https://maps.app.goo.gl/bddfiAsgx5PQD3ba9', note: "✅ 탑승 루트: 1. 스트라스부르 중앙역(Gare de Strasbourg) 이동 → 2. 전광판에서 'Colmar' 또는 'Mulhouse / Basel'행 플랫폼 번호(Voie) 확인 → 3. 기차 겉면 '2' (2등석) 칸에 자유롭게 착석 (소요 시간 약 30분)" },
      ...
      { id: 'day6_04', lang_id: 'day6_04', type: 'food',        time: '12:00–13:30', title: '🍷 점심: WISTUB BRENNER', tags: [{cls:'tag-confirm',text:'⏰ 12:00'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: 'Onion tart, Braised pork knuckle/Pinot, Cordon Bleu', maps_url: 'https://maps.app.goo.gl/7Qjy6YBsjJN3EdNF9', foldNote: "전채: 양파 타르트 (Tarte à l'oignon de Papi Lucien) 쉐어<br>메인: 돼지 무릎 찜 (Jarret de Porc braisé) + Cordon Bleu (코르동 블루 - 치즈를 품은 닭/송아지 고기 튀김) 추천." },
      { id: 'day6_05', lang_id: 'day6_05', type: 'food',        time: '13:30–14:30', title: '🍰 카페: Pâtisserie Gilg', detail: '초코에끌레어, 구겔호프, 밀푀유', maps_url: 'https://maps.app.goo.gl/wEwyyJ1aLppDrB319' },
      { id: 'day6_06', lang_id: 'day6_06', type: 'sightseeing', time: '14:30–15:30', title: '🛍 산책 & 쇼핑', detail: 'Rue des Clefs 탐방 → 북쪽으로 걸으며 Rue des Têtes 진입 → Maison des Têtes(하우스 오브 헤드) 구경 + 소품샵/기념품 구매', maps_url: 'https://maps.app.goo.gl/t44xon23yMH67rn78' },
      ...
      { id: 'day6_09', lang_id: 'day6_09', type: 'transport',   time: '16:50–17:30', title: '🚂 콜마르 → 스트라스부르 복귀', note: "✅ 탑승 루트: 1) 전광판에서 'Strasbourg'행 플랫폼 확인 → 2) 자유석 착석 (약 30분) → 3. 스트라스부르 중앙역(Gare de Strasbourg)" },
      { id: 'day6_10', type: 'transport',   time: '17:30–18:00', title: '🚶 도보 이동' },
      { id: 'day6_11', lang_id: 'day6_11', type: 'food',        time: '18:00–20:00', title: '🐟 저녁: Maison Kammerzell', tags: [{cls:'tag-confirm',text:'⏰ 18:15'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: 'Choucroute aux Poissons(생선 슈쿠르트), Coq au Riesling(리슬링 와인에 졸인 닭고기), 잔 와인: Riesling(화이트)', maps_url: 'https://maps.app.goo.gl/EfMdpUQtHNk9tMg2A' },
  ...
  7: {
    ...
    events: [
      { id: 'day7_01', lang_id: 'day7_01', type: 'transport',   time: '08:00–09:00', title: '🚋 트램 이동 (Port du Rhin역)', note: '✅ 탑승 루트: 숙소 앞 Ancienne Synagogue / Les Halles 역 → 트램 D (Kehl Rathaus 방향) → Port du Rhin 하차' },
      { id: 'day7_02', type: 'sightseeing', time: '09:00–10:00', title: '🌿 두 히브 가든', maps_url: 'https://maps.app.goo.gl/7W2PETNypQtZ8YaL6' },
      { id: 'day7_03', type: 'sightseeing', time: '10:00–11:00', title: '🌉 Passerelle des Deux Rives 다리', maps_url: 'https://maps.app.goo.gl/zj6ZvML9YFymEWb29' },
      { id: 'day7_04', type: 'sightseeing', time: '11:00–12:00', title: '🌊 라인강변 산책', detail: '은전나무 전망대(Weißtannenturm) → St. Johannes Nepomuk', maps_url: 'https://maps.app.goo.gl/muLquH28S5XriDnx9' },
      { id: 'day7_05', lang_id: 'day7_05', type: 'food',        time: '12:00–13:30', title: '🥨 점심(카페): Café Backhaus Dreher', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '프레첼(Brezel), 버터 프레첼(Butterbrezel), 아우프슈니트 (Aufschnitt), 밀히카피(Milchkaffee), 카페 크레마(Café Crème)', maps_url: 'https://maps.app.goo.gl/SssgYb2RASvds1uc6' },
      { id: 'day7_06', lang_id: 'day7_06', type: 'sightseeing', time: '13:30–16:00', title: '🛒 City Center Kehl(쇼핑몰)', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: 'DM 등 마트 쇼핑', maps_url: 'https://maps.app.goo.gl/oKUh25L7y6c272d58' },
      { id: 'day7_07', lang_id: 'day7_07', type: 'transport',   time: '16:00–16:30', title: '🚋 스트라스부르 복귀, 숙소 짐 내려놓기', note: '✅ 탑승 루트: Kehl Bahnhof 역 → 트램 D (Poteries 방향) → 숙소 앞 Ancienne Synagogue / Les Halles 역 하차' },
      { id: 'day7_08', lang_id: 'day7_08', type: 'sightseeing', time: '16:30–19:00', title: '🛍 Place des Halles(쇼핑몰)', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: 'Auchan 쇼핑', maps_url: 'https://maps.app.goo.gl/iFs3UhVuehbbXzjf8' },
      { id: 'day7_09', type: 'transport',   time: '19:00–19:30', title: '🚶 숙소에 마트 짐 내려놓고 도보 이동' },
      { id: 'day7_10', lang_id: 'day7_10', type: 'food',        time: '19:30–21:00', title: '🍷 저녁: Le Tire-Bouchon', tags: [{cls:'tag-confirm',text:'⏰ 19:30'}, {cls:'tag-toilet',text:'🚻 화장실'}], detail: 'Joues de porc au pinot noir (피노 누아에 졸인 돼지 뽈살) & spaetzle(알자스식 수제비), Munster coiffé(뮌스터 쿠아페)', maps_url: 'https://maps.app.goo.gl/aJnQMWgfH3gVnqAV6', foldNote: "MENU DORETTE MULLER (32.50€) 세트 주문<br>전채: Soupe à l'oignon gratinée (양파 수프)<br>메인: Joues de porc au Pinot Noir, spaetzle<br>디저트: Strudel aux pommes<br>단품 추가: Munster coiffé<br>잔 와인: Pinot Noir(레드), Gewürztraminer(화이트)" },
      { id: 'day7_11', type: 'transport',   time: '21:00–21:30', title: '🚶 숙소 복귀', note: '✅ 도보: 식당 → 대성당 대광장 → 숙소까지 도보 15분' },
      { id: 'day7_12', type: 'hotel',       time: '21:30',       title: '🧳 숙소 휴식 및 캐리어 짐 싸기', maps_url: 'https://maps.app.goo.gl/8LqmD3FP6Ep9ZyH98' }
    ]
  },
  ...
  8: {
    ...
    events: [
      { id: 'day8_01', lang_id: 'day8_01', type: 'hotel',     time: '06:00–07:00', title: '🧳 체크아웃', maps_url: 'https://maps.app.goo.gl/8LqmD3FP6Ep9ZyH98' },
      { id: 'day8_02', lang_id: 'day8_02', type: 'transport', time: '07:00–10:00', title: '🚄 TGV 이동 스트라스부르 → 샤를드골공항(터미널2E)', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '출발: 07:31 Strasbourg<br>도착: 09:29 Paris Aéroport Roissy CDG 2 (Gare TGV)', maps_url: 'https://maps.app.goo.gl/bddfiAsgx5PQD3ba9', note: '✅ 기차 TGV INOUI no.5470 - 좌석: Voiture 6 / 638–639' },
      { id: 'day8_03', lang_id: 'day8_03', type: 'transport', time: '09:30–10:00', title: '🚋 CDGVAL(무료 셔틀 열차) 탑승하여 제1터미널(Terminal 1)로 이동' },
      { id: 'day8_04', lang_id: 'day8_04', type: 'food',      time: '10:00–11:00', title: '🍔 아점: 맥도날드', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '280™ Original(Bœuf Blanc), McWrap 등' },
      { id: 'day8_05', lang_id: 'day8_05', type: 'note',      time: '11:00–15:25', title: '⏳ 택스리펀 처리 및 대기', detail: 'PABLO 기계로 택스리펀 바코드 스캔 완료, 카운터가 열릴 때까지 휴식' },
      { id: 'day8_06', lang_id: 'day8_06', type: 'transport', time: '15:25–16:15', title: '🛄 아시아나 카운터 오픈 (Terminal 1, Hall 1) 및 수하물 위탁', detail: '오픈 시간에 맞춰 1등으로 줄 서서 짐 부치기' },
      { id: 'day8_07', lang_id: 'day8_07', type: 'transport', time: '16:15–16:40', title: '🛂 보안 검색(Security) 및 출국 심사(Passport Control) 통과' },
      { id: 'day8_08', lang_id: 'day8_08', type: 'food',      time: '16:40–17:40', title: '🍽 저녁: Bistrot Benoît', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '제1터미널 면세 구역 Level 5' },
      { id: 'day8_09', lang_id: 'day8_09', type: 'sightseeing', time: '17:40–18:25', title: '🛍 구경 및 휴식, 탑승 게이트로 이동' },
      { id: 'day8_10', type: 'transport', time: '18:25–14:40 (3/15)', title: '✈️ 출국 아시아나 OZ0502', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '파리(CDG) 출발 → 서울(ICN) 도착' },
