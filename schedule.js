window.SCHEDULE_DATA = {
  ...
  2: {
    ...
    events: [
      { id: 'day2_01', type: 'food',       time: '08:30–09:40', title: '🥐 아침: Carette (보쥬 광장 점)', detail: '크루아상, 뺑 오 쇼콜라, 쇼송 오 뽐므, 핫초코, 오렌지 주스', maps_url: 'https://maps.app.goo.gl/6pMKuJy1v6mad6W67', foldNote: '아침 세트(Petit Déjeuner CARETTE): 21.0€<br>세트 구성: 핫초코 + 오렌지 주스 + 크루아상 + 식빵 토스트 1조각과 유기농 잼<br>쇼콜라 까레뜨로 업그레이드(샹티이 추가), 뺑 오 쇼콜라 및 쇼송 오 뽐므 단품 추가' },
      ...
      { id: 'day2_06', type: 'food',        time: '12:00–13:00', title: "🥙 점심: L'As du Fallafel", tags: [{type:'openrun',text:'🚶오픈런'}], detail: 'Falafel sandwich, Shawarma pita', maps_url: 'https://maps.app.goo.gl/iUi5xbPobLxwC7uZ9' },
      { id: 'day2_07', type: 'food',        time: '13:00–15:00', title: '🍵 카페/티타임: Mariage Frères Marais', detail: "애프터눈 티 세트 'SWEET DREAM' : JOYFUL HORSE 선택, UME CHA 2026 단품 추가", maps_url: 'https://maps.app.goo.gl/n5vXL5dWWYv3UBPW6', foldNote: '마라톤 코스가 Rue de Rivoli(리볼리 거리) 및 시청사 인근을 통과하므로, 오후 2시 이전에는 남쪽(센강 방향)으로 무리하게 이동하지 말 것.' },
  ...
  3: {
    ...
    events: [
      ...
      { id: 'day3_08', type: 'food',        time: '11:30–13:00', title: '🦆 점심: Bistrot Victoires', tags: [{type:'openrun',text:'🚶오픈런'}], detail: 'Confit de canard 오리 콩피', maps_url: 'https://maps.app.goo.gl/L9WwCf1UFYEryfu57' },
      ...
      { id: 'day3_18', type: 'food',        time: '19:30–21:00', title: '🐌 저녁: Bouillon République', tags: [{type:'confirm',text:'⏰ 19:30'}], detail: "Escargots (6개), Soupe à l'oignon, Bœuf bourguignon", maps_url: 'https://maps.app.goo.gl/RsEZ4NyA5QZxSmsU7', foldNote: "전채(Entrée): Escargots 6개 + Soupe à l'oignon 쉐어<br>메인(Plat): Bœuf bourguignon 쉐어<br>주류: 피노 누아(Pinot Noir) 계열의 레드 와인 하프 보틀" },
  ...
  4: {
    ...
    events: [
      { id: 'day4_01', type: 'food',        time: '07:30–08:30', title: '🥐 아침: Le Pain des Copains', detail: '산딸기 크루아상, 피스타치오 크루아상, 플랑', maps_url: 'https://maps.app.goo.gl/B2TddHQuT2KbUm8x6' },
      ...
      { id: 'day4_03', type: 'food',        time: '10:30–11:00', title: '🥖 점심: 유토피아 베이커리', detail: '흑임자 éclair, baguette, 카페 알롱제(Café allongé)', maps_url: 'https://maps.app.goo.gl/HdKJ3EthYLNV2Diq9' },
      ...
      { id: 'day4_05', type: 'sightseeing', time: '11:30–12:00', title: '💌 우체국: La Poste', detail: '160 Rue du Temple, 75003 Paris, 프랑스<br>집으로 엽서 보내기', maps_url: 'https://maps.app.goo.gl/sur3ob9K4of7aPvWA' },
      ...
      { id: 'day4_13', type: 'food',        time: '17:00–18:00', title: '☕ Sunflower Café', detail: '커피, 아보카도 샌드위치', maps_url: 'https://maps.app.goo.gl/qGLvH9xShzdxbSaM7' },
      ...
      { id: 'day4_16', type: 'food',        time: '19:15–21:00', title: "🥩 저녁: L'Atypic", tags: [{type:'confirm',text:'⏰ 19:15'}], detail: '푸아그라, 타르타르, 스테이크', maps_url: 'https://maps.app.goo.gl/uaBj9PL2qWF4r8cB9', foldNote: '전채(Entrée): 푸아그라(Foie gras)<br>푸아그라는 빵에 발라 먹으면 되며, 이때 셰프에게 추천받아 달콤한 화이트 와인(예: 소테른 Sauternes) 1잔을 곁들여 푸아그라의 풍미를 극대화<br>메인(Plat): 타르타르(프랑스식 육회) + 스테이크(Steak)' },
      { id: 'day4_17', type: 'transport',   time: '21:00–21:30', title: '🚶 선착장으로 이동' },
      { id: 'day4_18', type: 'sightseeing', time: '21:30–22:30', title: '🚢 바토 파리지앵 탑승', tags: [{type:'confirm',text:'⏰ 21:30'}], detail: '에펠탑과 센강의 완전한 밤 풍경 감상', maps_url: 'https://maps.app.goo.gl/yxCDpmpt28zLXfRR9' },
  ...
  5: {
    ...
    events: [
      ...
      { id: 'day5_05', type: 'food',      time: '13:00–14:30', title: '🍽 점심: Winstub Le Zehnerglock', tags: [{type:'confirm',text:'⏰ 13:00'}], detail: 'Choucroute Garnie(슈쿠르트), Baeckeoffe(베크오프), 알자스산 화이트 와인(Riesling 리슬링)', maps_url: 'https://maps.app.goo.gl/tsKG6i91WJsgqM1Q9' },
      ...
      { id: 'day5_09', type: 'food',      time: '18:30–20:00', title: '🔥 저녁: La Fignette', tags: [{type:'openrun',text:'🚶오픈런'}], detail: '플람퀴슈(Tarte Flambée Traditionnelle, Gratinée)', maps_url: 'https://maps.app.goo.gl/scasdyVUWjxo9mT39' },
  ...
  6: {
    ...
    events: [
      ...
      { id: 'day6_11', type: 'food',        time: '18:00–20:00', title: '🐟 저녁: Maison Kammerzell', tags: [{type:'confirm',text:'⏰ 18:15'}], detail: 'Choucroute aux Poissons(생선 슈쿠르트), Coq au Riesling(리슬링 와인에 졸인 닭고기), 잔 와인: Riesling(화이트)', maps_url: 'https://maps.app.goo.gl/EfMdpUQtHNk9tMg2A' },
