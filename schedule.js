window.SCHEDULE_DATA = {
  ...
  3: {
    ...
    events: [
      ...
      { id: 'day3_13', lang_id: 'day3_13', type: 'sightseeing', time: '15:20–17:00', title: '🎨 오랑주리 미술관', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], tags: [{cls:'tag-confirm',text:'⏰ 15:30'}], detail: "모네 '수련' 관람", maps_url: 'https://maps.app.goo.gl/C2Ecdk6QVuGC6MgB7' },
  ...
  4: {
    ...
    events: [
      ...
      { id: 'day4_18', lang_id: 'day4_18', type: 'sightseeing', time: '21:30–22:30', title: '🚢 바토 파리지앵 탑승', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], tags: [{cls:'tag-confirm',text:'⏰ 21:30'}], detail: '에펠탑과 센강의 완전한 밤 풍경 감상', maps_url: 'https://maps.app.goo.gl/yxCDpmpt28zLXfRR9' },
  ...
  5: {
    ...
    events: [
      ...
      { id: 'day5_06', type: 'sightseeing', time: '14:30–16:00', title: '⛩ 스트라스부르 대성당', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: '외부 파사드 감상 → 내부 입장 → 천문시계', maps_url: 'https://maps.app.goo.gl/wJAaRakMQhU48mLR9' },
  ...
  8: {
    ...
    events: [
      ...
      { id: 'day8_05', lang_id: 'day8_05', type: 'note',      time: '11:00–15:25', title: '⏳ 택스리펀 처리 및 대기', tags: [{cls:'tag-toilet',text:'🚻 화장실'}], detail: 'PABLO 기계로 택스리펀 바코드 스캔 완료, 카운터가 열릴 때까지 휴식' },
