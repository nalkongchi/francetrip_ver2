window.SCHEDULE_DATA = {
  ...
  2: {
    ...
    events: [
      { id: 'day2_01', type: 'transport', time: '08:00–08:30', title: '🚇 보쥬 광장 이동', note: '✅ 탑승 루트: 숙소 앞 République(레퓌블리크) 역 진입 → 지하철 8호선(Créteil / Pointe du Lac 방향) 탑승 → Chemin Vert(슈망 베르) 역 하차 → Place des Vosges(보쥬 광장) 방향 출구 이용 (도보 약 5분)' },
      { id: 'day2_02', type: 'food',       time: '08:30–09:40', title: '🥐 아침: Carette (보쥬 광장 점)', detail: '크루아상, 뺑 오 쇼콜라, 쇼송 오 뽐므, 핫초코, 오렌지 주스', maps_url: 'https://maps.app.goo.gl/6pMKuJy1v6mad6W67', foldNote: '아침 세트(Petit Déjeuner CARETTE): 21.0€<br>세트 구성: 핫초코 + 오렌지 주스 + 크루아상 + 식빵 토스트 1조각과 유기농 잼<br>쇼콜라 까레뜨로 업그레이드(샹티이 추가), 뺑 오 쇼콜라 및 쇼송 오 뽐므 단품 추가' },
      ...
      { id: 'day2_04', type: 'sightseeing', time: '10:20–11:00', title: '🏠 빅토르 위고 하우스', detail: '외관 구경, 시간 되면 내부 관람(무료)', maps_url: 'https://maps.app.goo.gl/KRC8g3DnkpM3Q53u6' },
      ...
      { id: 'day2_07', type: 'food',        time: '12:00–13:00', title: "🥙 점심: L'As du Fallafel", tags: [{cls:'tag-openrun',text:'🚶오픈런'}], detail: 'Falafel sandwich, Shawarma pita', maps_url: 'https://maps.app.goo.gl/iUi5xbPobLxwC7uZ9' },
      { id: 'day2_08', type: 'food',        time: '13:00–15:00', title: '🍵 카페/티타임: Mariage Frères Marais', detail: "애프터눈 티 세트 'SWEET DREAM' : JOYFUL HORSE 선택, UME CHA 2026 단품 추가", maps_url: 'https://maps.app.goo.gl/n5vXL5dWWYv3UBPW6', foldNote: '마라톤 코스가 Rue de Rivoli(리볼리 거리) 및 시청사 인근을 통과하므로, 오후 2시 이전에는 남쪽(센강 방향)으로 무리하게 이동하지 말 것.' },
      ...
      { id: 'day2_11', type: 'sightseeing', time: '16:30–17:30', title: '⛪ 노트르담 대성당', detail: '정면 파사드 → 측면/후면으로 한 바퀴 → 내부 입장 및 관람 → 광장 포토스팟', maps_url: 'https://maps.app.goo.gl/LjFBhCaFeZRdprCC6' },
      ...
      { id: 'day2_14', type: 'transport',   time: '18:30–18:50', title: '🚇 지하철로 루브르 이동', note: '✅ 탑승 루트: 7호선 Pont Marie 역 → Palais Royal - Musée du Louvre 역 하차' },
      ...
      { id: 'day2_17', type: 'food',        time: '20:00–21:30', title: '🥞 저녁: Breizh Café Montorgueil', tags: [{cls:'tag-confirm', text:'⏰ 20:00'}], detail: 'La Complète 갈레트(햄, 치즈, 계란), 특선 갈레트(Galette de spécialité), Cidre Brut(시드르 브뤼)', maps_url: 'https://maps.app.goo.gl/KQFsWWwbjBQokuza9', foldNote: '메인: La Complète 갈레트(햄, 치즈, 계란) 1개 + 해산물이나 버섯이 들어간 특선 갈레트(Galette de spécialité) 1개<br>주류: 드라이한 사과주 Cidre Brut(시드르 브뤼)를 피셰(단지)로 주문해서 나눠 먹기<br>디저트: 식후에 달콤한 Caramel au beurre salé (수제 솔티드 카라멜 크레페) 하나를 추가(선택)' },
      { id: 'day2_18', type: 'transport',   time: '21:30–22:00', title: '🚇 식당 → 숙소 복귀', note: '✅ 지하철 3호선 Sentier → République (환승 없음) / 하차 후: Sortie 5 (Boulevard de Magenta) 출구' },
  ...
  3: {
    ...
    events: [
      ...
      { id: 'day3_08', type: 'food',        time: '11:30–13:00', title: '🦆 점심: Bistrot Victoires', tags: [{cls:'tag-openrun',text:'🚶오픈런'}], detail: 'Confit de canard 오리 콩피', maps_url: 'https://maps.app.goo.gl/L9WwCf1UFYEryfu57' },
