window.SCHEDULE_DATA = {
  ...
  4: {
    ...
    events: [
      ...
      { id: 'day4_16', type: 'food',        time: '19:15–21:00', title: "🥩 저녁: L'Atypic", tags: [{cls:'tag-confirm',text:'⏰ 19:15'}], detail: '푸아그라, 타르타르, 스테이크', maps_url: 'https://maps.app.goo.gl/uaBj9PL2qWF4r8cB9', foldNote: '전채(Entrée): 푸아그라(Foie gras)<br>푸아그라는 빵에 발라 먹으면 되며, 이때 셰프에게 추천받아 달콤한 화이트 와인(예: 소테른 Sauternes) 1잔을 곁들여 푸아그라의 풍미를 극대화<br>메인(Plat): 타르타르(프랑스식 육회) + 스테이크(Steak)' },
      { id: 'day4_17', type: 'transport',   time: '21:00–21:30', title: '🚶 선착장으로 이동' },
      { id: 'day4_18', type: 'sightseeing', time: '21:30–22:30', title: '🚢 바토 파리지앵 탑승', tags: [{cls:'tag-confirm',text:'⏰ 21:30'}], detail: '에펠탑과 센강의 완전한 밤 풍경 감상', maps_url: 'https://maps.app.goo.gl/yxCDpmpt28zLXfRR9' },
