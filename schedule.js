window.SCHEDULE_DATA = {
  ...
  6: {
    ...
    events: [
      { id: 'day6_01', lang_id: 'day6_01', type: 'transport',   time: '08:00–09:00', title: '🚂 스트라스부르 → 콜마르 (TER 기차)', maps_url: 'https://maps.app.goo.gl/bddfiAsgx5PQD3ba9', note: "✅ 탑승 루트: 1. 스트라스부르 중앙역(Gare de Strasbourg) 이동 → 2. 전광판에서 'Colmar' 또는 'Mulhouse / Basel'행 플랫폼 번호(Voie) 확인 → 3. 기차 겉면 '2' (2등석) 칸에 자유롭게 착석 (소요 시간 약 30분)" },
      ...
      { id: 'day6_11', lang_id: 'day6_11', type: 'food',        time: '18:00–20:00', title: '🐟 저녁: Maison Kammerzell', tags: [{cls:'tag-confirm',text:'⏰ 18:15'}], detail: 'Choucroute aux Poissons(생선 슈쿠르트), Coq au Riesling(리슬링 와인에 졸인 닭고기), 잔 와인: Riesling(화이트)', maps_url: 'https://maps.app.goo.gl/EfMdpUQtHNk9tMg2A' },
  ...
  7: {
    ...
    events: [
      ...
      { id: 'day7_05', lang_id: 'day7_05', type: 'food',        time: '12:00–13:30', title: '🥨 점심(카페): Café Backhaus Dreher', detail: '프레첼(Brezel), 버터 프레첼(Butterbrezel), 아우프슈니트 (Aufschnitt), 밀히카피(Milchkaffee), 카페 크레마(Café Crème)', maps_url: 'https://maps.app.goo.gl/SssgYb2RASvds1uc6' },
      { id: 'day7_06', lang_id: 'day7_06', type: 'sightseeing', time: '13:30–16:00', title: '🛒 City Center Kehl(쇼핑몰)', detail: 'DM 등 마트 쇼핑', maps_url: 'https://maps.app.goo.gl/oKUh25L7y6c272d58' },
      ...
      { id: 'day7_08', lang_id: 'day7_08', type: 'sightseeing', time: '16:30–19:00', title: '🛍 Place des Halles(쇼핑몰)', detail: 'Auchan 쇼핑', maps_url: 'https://maps.app.goo.gl/iFs3UhVuehbbXzjf8' },
  ...
  8: {
    ...
    events: [
      ...
      { id: 'day8_02', lang_id: 'day8_02', type: 'transport', time: '07:00–10:00', title: '🚄 TGV 이동 스트라스부르 → 샤를드골공항(터미널2E)', detail: '출발: 07:31 Strasbourg<br>도착: 09:29 Paris Aéroport Roissy CDG 2 (Gare TGV)', maps_url: 'https://maps.app.goo.gl/bddfiAsgx5PQD3ba9', note: '✅ 기차 TGV INOUI no.5470 - 좌석: Voiture 6 / 638–639' },
      { id: 'day8_03', lang_id: 'day8_03', type: 'transport', time: '09:30–10:00', title: '🚋 CDGVAL(무료 셔틀 열차) 탑승하여 제1터미널(Terminal 1)로 이동' },
      { id: 'day8_04', lang_id: 'day8_04', type: 'food',      time: '10:00–11:00', title: '🍔 아점: 맥도날드', detail: '280™ Original(Bœuf Blanc), McWrap 등' },
      ...
      { id: 'day8_08', lang_id: 'day8_08', type: 'food',      time: '16:40–17:40', title: '🍽 저녁: Bistrot Benoît', detail: '제1터미널 면세 구역 Level 5' },
